 ...
 *
 * @author Sri Chandraiah, Rahul Sanghvi
 *
 */
public abstract class ListTest {
    ...
    /**
     * Tests retreat when left has one element and right is empty.
     */
    @Test
    ...
    /**
     * Tests retreat when left is non-empty and right is empty.
     */
    @Test
    ...
    /**
     * Tests retreat when left has one element and right is non-empty.
     */
    @Test
    public final void testRetreatLeftOneRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "yellow", "orange", "purple",
                "red");
        List<String> list2 = this.createFromArgsRef(3, "yellow", "orange", "purple",
                "red");
        /*
    ...
    /**
     * Tests retreat when both left and right are non-empty.
     */
    @Test
